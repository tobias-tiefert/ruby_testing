...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the previous step ist 16' do
      it 'returns 12' do
        previous_step = 16
  ...
  describe '#subtract_random_number' do
    context 'when the previous step is 10 and random number is 3' do
  ...
  describe '#play' do
    context 'when the random number is 1038' do
      # remove the 'x' before running this test
      subject(:game_high) { described_class.new(1038) }
      it 'will return 7' do
    ...
    context 'when the random number is 0' do
      # remove the 'x' before running this test
      subject(:game_zero) { described_class.new(0) }
      it 'will return 7' do
        result = game_zero.play
        expect(result).to eq(7)
      end
    end
    ...
    context 'when the random number is 18' do
      # remove the 'x' before running this test
      subject(:game_eighten) { described_class.new(18) }
      it 'will return 7' do
        result = game_eighten.play
        expect(result).to eq(7)
      end
    end
  end
