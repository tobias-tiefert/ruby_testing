...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:wrong_guess) { described_class.new(5, '7') }
      # remove the 'x' before running this test
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        number_to_high = '39'
        valid_input = '8'
        allow(game_loop).to receive(:player_input).and_return(letter, number_to_high, valid_input)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      subject(:game_five) { described_class.new(9, '9', 5) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        that_was_hard = "That was hard. It took you 5 guesses!\n"
        expect { game_five.final_message }.to output(that_was_hard).to_stdout
      end
    end
  end
end
